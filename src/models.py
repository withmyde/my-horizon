...
class ArxivConfig(BaseModel):
    """ArXiv paper source configuration."""
    enabled: bool = True
    categories: List[str] = Field(default_factory=lambda: ["cs.AI"])  # cs.AI = Artificial Intelligence
    max_results: int = 5  # Number of papers to fetch per day
